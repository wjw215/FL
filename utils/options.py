...
def args_parser():
    ...
    parser.add_argument("--algorithm", type=str, default="SFL")
    parser.add_argument("--limit_time", type=int, default=30000)
    parser.add_argument("--comm_limit", type=int, default=2e7)
    ...
    parser.add_argument('--estimate_grad', default=1, type=int)
